...
import { getBasicCases } from "../../actions/product.actions";
        ...
        >
          <MDBRow className="pb-5 pt-5" between>
            <MDBCol className="col-12 col-sm-4 col-md-3 col-lg-3">
              <h3 className="font-weight-bold">Basic Cases</h3>
            </MDBCol>
...
const mapStateToProps = (state) => {
  return {
    products: state.productData.basicCasesProduct || [],
...
const mapDispatchToProps = (dispatch) => {
  return {
    onGetProduct: () => {
      dispatch(getBasicCases());
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(BasicCases);
