...
import { getJustForYouProduct } from "../../actions/product.actions";
...
const JustForYouProducts = (props) => {
...
const mapStateToProps = (state) => {
  return {
    products: state.productData.justForYouProducts || [],
...
export default connect(mapStateToProps, mapDispatchToProps)(JustForYouProducts);
